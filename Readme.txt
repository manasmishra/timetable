...
Steps to run:
simply type npm start or node app.js to run the code.
I have used command line output to show output for all the three problems with a ------- separator between solutions.
